                ...
                <div className="row g-4 justify-content-center">
                    <div className="col-12 col-lg-8">
                        <div className="details-thumb">
                            <img src="/assets/img/hotel-details/tour-details.jpg" alt="img" />
                            <ul className="image-list">
                                <li>
                                    <img src="/assets/img/hotel-details/tour-details-2.jpg" alt="img" />
                                </li>
                                <li>
                                    <img src="/assets/img/hotel-details/tour-details-3.jpg" alt="img" />
                                </li>
                                <li>
                                    <img src="/assets/img/hotel-details/tour-details-4.jpg" alt="img" />
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <div ref={accordionContentRef} id="faq1" className="accordion-collapse collapse"
                                                ...
                                                <div className="accordion-body">
                                                    ...
                                                    <div className="faq-image">
                                                        <img src="/assets/img/hotel-details/faq-img.jpg" alt="img" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="col-12 col-lg-4">
                        <div className="main-bar main-sideber">
                            ...
                            <div className="booking-bg bg-cover" data-background="/assets/img/hotel-details/booking-bg.jpg">
